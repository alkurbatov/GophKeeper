...
func (c *secretsClient) Create(ctx context.Context, in *CreateSecretRequest, opts ...grpc.CallOption) (*CreateSecretResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/goph.keeper.v1.Secrets/Create", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *secretsClient) List(ctx context.Context, in *ListSecretsRequest, opts ...grpc.CallOption) (*ListSecretsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/goph.keeper.v1.Secrets/List", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *secretsClient) Get(ctx context.Context, in *GetSecretRequest, opts ...grpc.CallOption) (*GetSecretResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/goph.keeper.v1.Secrets/Get", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *secretsClient) Update(ctx context.Context, in *UpdateSecretRequest, opts ...grpc.CallOption) (*UpdateSecretResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/goph.keeper.v1.Secrets/Update", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *secretsClient) Delete(ctx context.Context, in *DeleteSecretRequest, opts ...grpc.CallOption) (*DeleteSecretResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/goph.keeper.v1.Secrets/Delete", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Secrets_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/goph.keeper.v1.Secrets/Create",
	}
...
func _Secrets_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/goph.keeper.v1.Secrets/List",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Secrets_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/goph.keeper.v1.Secrets/Get",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Secrets_Update_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/goph.keeper.v1.Secrets/Update",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Secrets_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/goph.keeper.v1.Secrets/Delete",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
